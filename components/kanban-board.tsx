...
import { closestCorners, DndContext, DragEndEvent, DragStartEvent, useDroppable, useSensor, useSensors, PointerSensor, DragOverlay} from "@dnd-kit/core";
...
function SortableJobCard({
    ...
    return (
        ...
        <JobApplicaationCard job={job} columns={columns} dragHandleProps={{...attributes, ...listeners}} />
    </div>
    )
}
export default function KanbanBoard({board, userId}: KanbanBoardProps){
  ...
  const activeJob = sortedColumns
    ...
    <DragOverlay>
        {activeJob ? (
            <div className="opacity-50"><JobApplicaationCard job={activeJob} columns={sortedColumns}></JobApplicaationCard></div>)
            : null }
    </DragOverlay>
    </DndContext>
    );
